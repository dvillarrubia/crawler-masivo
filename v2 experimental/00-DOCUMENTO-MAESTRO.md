...
- [ ] **Fase 1 (ejecución real)** — PENDIENTE: build+run del contenedor gliner sobre workoholics, gold set anotado a mano, calibración de umbrales por barrido, criterios de éxito 1-3 (F1, precisión de mismatch sobre 30, throughput CPU)
